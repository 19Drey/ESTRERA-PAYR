...
usertable.getTableHeader().setForeground(new java.awt.Color(0, 128, 128));
        ...
        try{
            ...
            ResultSet rs = dbc.getData("SELECT uid,lname,fname,ussername,useremail,utype,stats FROM users");
            usertable.setModel(DbUtils.resultSetToTableModel(rs));
               ...
               columnModel.getColumn(5).setHeaderValue("Usertype");
...
public boolean idcheck() {
    dbconnect dbc = new dbconnect();
    String userId = idd.getText(); // Input user ID
    boolean found = false;
    ...
    try {
        ...
        // Check in logged
        ResultSet rs5 = dbc.getData("SELECT * FROM logged WHERE userid = '" + userId + "'");
    ...
    private void deleteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_deleteMouseClicked
       Session sess = Session.getInstance();
        ...
        return;
         ...
         if(idd.getText().equals(cuser)){
             JOptionPane.showMessageDialog(null, "failed to delete user");
         }
        }else{
        dbc.deleteData("DELETE FROM users WHERE uid = '"+idd.getText()+"'");
        displayData();
        String actionn = "Deleted users with ID No.: " + idd.getText();
