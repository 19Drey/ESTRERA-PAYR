...
public class logged extends javax.swing.JInternalFrame {
    ...
    public logged() {
      ...
      tablelogged.getTableHeader().setOpaque(true); // Set to true for visibility of background
tablelogged.getTableHeader().setBackground(Color.white); // Set background to white
tablelogged.getTableHeader().setForeground(new java.awt.Color(0, 128, 128)); // Set foreground to green
