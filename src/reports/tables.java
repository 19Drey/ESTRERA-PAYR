...
tables.getTableHeader().setBackground(new java.awt.Color(0, 128, 0)); // Green background
tables.getTableHeader().setForeground(Color.white); // White text
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, -30, 110, 30));
