...
public class logs extends javax.swing.JInternalFrame {
    ...
    public logs() {
      ...
      tablelogs.getTableHeader().setOpaque(true); // Set to true for visibility of background
tablelogs.getTableHeader().setBackground(Color.white); // Set background to white
tablelogs.getTableHeader().setForeground(new java.awt.Color(0, 128, 128)); // Set foreground to green
